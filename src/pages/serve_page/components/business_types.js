    ...
    <section className={"business-types-area"}>
      <div className={"container"}>
        <h1
          ...
          style={{ paddingTop: 70 }}
        >
          Types of Small Business We Help With our Accountancy Services
        </h1>
      </div>
      <div className={"container"}>
        <div className={"row row-eq-height justify-content-center mt-5"}>
          {businessData.map((data, index) => (
            <div
              className={"col-lg-4 col-md-6 text-center business-types-col"}
              key={index}
            >
              <img
                src={data.logo}
              ...
              />
              <h3 style={{ marginTop: 40 }}> {data.title}</h3>
        ...
        <div className={"row justify-content-center mt-5"}>
          {services.map((data) => (
            <div className={"col-lg-4 col-md-12 text-center"}>
              <img src={data.logo} height={80} width={80} />
              <h3 style={{ marginTop: 40 }}>{data.title}</h3>
          ...
          <div className={"row p-5 align-items-center"}>
            <div className={"col-lg-8 md-12 col-12"}>
              ...
              <p className={"text-white text-justify"}>
                As a small business owner, freelancer or contractor, spare time
                is precious. Switching your accountant may not be a priority and
                often get pushed to the bottom of the “to-do” list.
              </p>
            </div>
